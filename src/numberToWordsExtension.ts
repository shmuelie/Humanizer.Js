  ...
  Number.prototype.toWords = function(): string {
    ...
    var gender: GrammaticalGender =
      arguments.length >= 1 && typeof arguments[0] === 'number'
        ? arguments[0]
        : null
    var converter: Humanizer.Localisation.NumberToWords.INumberToWordsConverter = Configuration.Configurator.getNumberToWordsConverter(
      arguments.length > 0 &&
      typeof arguments[arguments.length - 1] === 'string'
        ? arguments[arguments.length - 1]
        : Resources.getCurrentCulture()
    )
    if (gender === null) {
