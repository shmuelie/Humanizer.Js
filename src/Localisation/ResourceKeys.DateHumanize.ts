namespace Humanizer.Localisation.ResourceKeys {
  'use strict'
  ...
  export class DateHumanize {
    ...
    static GetResourceKey = (
      ...
      var tense: string =
        timeUnitTense === Tense.Future ? DateHumanize.FromNow : DateHumanize.Ago
      var unit: string = timeUnit
        .toString()
        .toQuantity(count, Humanizer.ShowQuantityAs.None)
      return Humanizer.Resources.format(
        DateHumanize.DateTimeFormat,
        singularity,
        unit,
        tense
      )
