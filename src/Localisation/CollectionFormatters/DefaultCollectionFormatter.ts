namespace Humanizer.Localisation.CollectionFormatters {
  ...
  export class DefaultCollectionFormatter implements ICollectionFormatter {
      ...
      switch (arguments.length) {
        ...
        case 2:
          if (typeof arguments[1] === 'string') {
            return this.humanize_collection_separator<T>(
              collection,
              arguments[1]
            )
          }
          return this.humanizer_collection_objectFormatter<T>(
            collection,
            arguments[1]
          )
        case 3:
          return this.humanizer_collection_objectFormatter_separator<T>(
            collection,
            arguments[1],
            arguments[2]
          )
    ...
    humanize_collection_separator<T>(
      collection: T[],
      separator: string
    ): string {
      return this.humanizer_collection_objectFormatter_separator<T>(
    ...
    humanizer_collection_objectFormatter<T>(
      collection: T[],
      objectFormatter: (item: T) => string
    ): string {
      return this.humanizer_collection_objectFormatter_separator<T>(
    ...
    humanizer_collection_objectFormatter_separator<T>(
      collection: T[],
      objectFormatter: (item: T) => string,
      separator: string
    ): string {
