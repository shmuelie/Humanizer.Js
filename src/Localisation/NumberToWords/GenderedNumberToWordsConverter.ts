namespace Humanizer.Localisation.NumberToWords {
  ...
  export class GenderedNumberToWordsConverter
    implements INumberToWordsConverter {
    private defaultGender: GrammaticalGender

    constructor(
      defaultGender: GrammaticalGender = GrammaticalGender.Masculine
    ) {
    ...
    convertToOrdinal(): string {
      ...
      return this.convertToOrdinal_number_grammaticalGender(
        arguments[0],
        arguments[1]
      )
    }
    ...
    convert_number_grammaticalGender(
      num: number,
    ...
    convertToOrdinal_number_grammaticalGender(
      num: number,
      gender: GrammaticalGender
    ): string {
      throw new Error('Abstract')
