...
namespace Humanizer.Configuration.Configurator {
  'use strict'

  var formatter: LocaliserRegistry<
    Localisation.Formatter.IFormatter
  > = new FormatterRegistry()
  var ordinalizers: LocaliserRegistry<
    Localisation.Ordinalizers.IOrdinalizer
  > = new OrdinalizerRegistry()
  var collections: LocaliserRegistry<
    Localisation.CollectionFormatters.ICollectionFormatter
  > = new CollectionFormatterRegistry()
  var numberToWords: LocaliserRegistry<
    Localisation.NumberToWords.INumberToWordsConverter
  ...
  export function getNumberToWordsConverter(
    culture: string
  ): Localisation.NumberToWords.INumberToWordsConverter {
