...
namespace Humanizer.Configuration {
  export class NumberToWordsConverterRegistry extends LocaliserRegistry<
  ...
  > {
    constructor() {
      ...
      this.register(
        'en',
        new Localisation.NumberToWords.EnglishNumberToWordsConverter()
      )
      this.register(
        'ar',
        new Localisation.NumberToWords.ArabicNumberToWordsConverter()
      )
      this.register(
        'es',
        new Localisation.NumberToWords.SpanishNumberToWordsConverter()
      )
    }
  }
}
