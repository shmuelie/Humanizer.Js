...
namespace Humanizer {
  ...
  String.prototype.ordinalize = function(
    gender?: Humanizer.GrammaticalGender
  ): string {
    /// <signature>
    ///     <summary>
    ///         Turns a number into an ordinal string used to denote the position in an ordered sequence such as 1st, 2nd, 3rd, 4th.
    ...
    if (gender === undefined) {
      return Configuration.Configurator
        .getOrdinalizer()
        .convert(parseInt(this, 10), this)
    } else {
      return Configuration.Configurator
        .getOrdinalizer()
        .convert(parseInt(this, 10), this, gender)
    }
  }
  ...
  Number.prototype.ordinalize = function(
    ...
    if (gender === undefined) {
      return Configuration.Configurator
        .getOrdinalizer()
        .convert(this, this.toString())
    } else {
      return Configuration.Configurator
        .getOrdinalizer()
        .convert(this, this.String(), gender)
    }
  }
}
