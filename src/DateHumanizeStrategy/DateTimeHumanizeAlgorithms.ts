  ...
  export class DateTimeHumanizeAlgorithms {
    ...
    static precisionHumanize(
      ...
      var tense: Localisation.Tense =
        input > comparisonBase
          ? Localisation.Tense.Future
          : Localisation.Tense.Past
      ...
      if (months > 0) {
        return formatter.DateHumanize(
          Localisation.TimeUnit.Month,
          tense,
          months
        )
      }
    ...
    static defaultHumanize(
      ...
      if (ts < (500).milliseconds()) {
        return formatter.DateHumanize(
          Localisation.TimeUnit.Millisecond,
          tense,
          0
        )
      }
      ...
      if (ts < (24).hours()) {
        return formatter.DateHumanize(
          Localisation.TimeUnit.Hour,
          tense,
          Math.floor(ts.toHours())
        )
      }

      if (ts < (28).days()) {
        return formatter.DateHumanize(
          Localisation.TimeUnit.Day,
          tense,
          Math.floor(ts.toDays())
        )
      }
      ...
      if (ts >= (28).days() && ts < (30).days()) {
        ...
        compBase2.setMonth(
          comparisonBase.getMonth() +
            (tense === Localisation.Tense.Future ? 1 : -1)
        )
